...
<body style="background-color:#FDFAF6">
  ...
  <header>
    ...
    if(isset($_POST['fetch'])){
      ...
      $query="SELECT * FROM processor_image WHERE processor_name='$_POST[option]'"; 
            $res=mysqli_query($conn,$query);
            $row=mysqli_fetch_array($res);
            // echo var_dump($row);
            // echo"../images/processors/$row[6]";
              echo "<br>  
              <div class='container row '>
              <div class='container col p-2' style='margin-left:10%;'><img src='data:image;base64,".base64_encode($row['processor_image'])."' alt='Image' style='width:500px; margin-top:30%;'></div>
              <div class='container col mt-5 pt-5' style='width:60%; height:500px;margin-top:10%'><p class='text-center h2'><i><strong>$row[processor_name]</strong></i></p>
            <br>
              ...
              $query1 = "SELECT * FROM processor_details WHERE processor_name = '$_POST[option]'";   
