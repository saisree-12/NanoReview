...
<!-- image and features -->
        <!-- <form action="" method="POST" enctype="multipart/form-data"> -->
          ...
          if(isset($_POST["fetch"])){ 
            if($_POST["laptop_name"]==""){
              header("Location:L_search_pro.php");
            }
            $query="SELECT * FROM l_des_img WHERE Laptop_Names='$_POST[laptop_name]'"; 
            $res=mysqli_query($conn,$query);
            $row=mysqli_fetch_array($res);
              echo "<div class=' row container-fluid  ' style='width:90%; margin-top:6%;'>
               <div class='container col-sm-1 p-2 ' ><img src='data:image;base64,".base64_encode($row[1])."' alt='Image' style='width:600px ; height:450px; margin-top:30%;'></div>
              ...
              <div class='container shadow p-5 m-5' style='width:140%;' >
                        ...
                        <p class='h4' style='margin-left:0%;'><i><strong><span>&#10003;</span> &nbsp;&nbsp; Processor Name :</strong></i> $row[2] </p>
                        ...
                        <p class='h4'style='margin-left:0%;'><i><strong><span>&#10003;</span> &nbsp;&nbsp;Screen Size : </strong></i>$row[5] </p>
                        <p class='h4' style='margin-left:0%;'><i><strong><span>&#10003;</span> &nbsp;&nbsp;Screen Resolution :</strong></i> $row[6] </p>
              </div>
              </div>
              </div>";

              $query1 = "SELECT * FROM Laptops WHERE Laptop_Names = '$_POST[laptop_name]'";   
