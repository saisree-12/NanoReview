...
<html lang="en">
  ...
  <body style="background-color:#A7BBC7">
    ...
    <div class='container shadow my-5 p-5 ' style="background-color:#A7BBC7">
        <form action="form_laptop.php" method="post" enctype="multipart/form-data">
        <div class="form-floating mb-3">
            <input type="text" class="form-control" name="Name" style="height:50px" id="floatingInput" required placeholder="Name">
        </div><br>
        <div class="row row-cols-2">
            <div class="col-auto ms-auto col-sm-3" style="margin-left:20%">
                <input type="number" class="form-control" name="Performance" id="floatingInput" required rows="3"  min='0' step='1' max='100'placeholder="Performance">
            </div>
            <div class="col-auto ms-auto col-sm-3">
            <input type="number" class="form-control" id="floatingInput" name="Gaming"  required rows="3"  min='0' step='1' max='100'placeholder="Gaming">
            </div>
        </div><br><br>
        <div class="row row-cols-2">
            <div class="col-auto ms-auto col-sm-3" style="margin-left:20%">
                <input type="number" class="form-control" id="floatingInput" name="Display"  required rows="3"  min='0' step='1' max='100'placeholder="Display">
            </div>
            <div class="col-auto ms-auto col-sm-3">
            <input type="number" class="form-control" id="floatingInput"  name="Battery_Life" required rows="3"  min='0' step='1' max='100'placeholder="Battery Life">
            </div>
        </div><br><br>
        <div class="row row-cols-2">
            <div class="col-auto ms-auto col-sm-3" style="margin-left:20%">
                <input type="number" class="form-control" id="floatingInput"  name="Connectivity" required rows="3"  min='0' step='1' max='100'placeholder="Connectivity">
            </div>
            <div class="col-auto ms-auto col-sm-3">
        ...
        <div class='row row-cols-2'>
            ...
            <div class='col-auto ms-auto col-sm-3'>
            <input type='text' class='form-control' id='floatingInput' name='RAM'  required rows='3' placeholder='RAM'>
            </div>
        </div><br><br>
        <div class='row row-cols-2'>
            <div class='col-auto ms-auto col-sm-3' style='margin-left:20%'>
            ...
            <div class='col-auto ms-auto col-sm-3'>
            <input type='text' class='form-control' id='floatingInput'  name='Graphic_Processor' required rows='3' placeholder='Graphic processing'>
            </div>
        </div><br><br>
        <div class='row row-cols-2'>
            <div class='col-auto ms-auto col-sm-3' style='margin-left:20%'>
                <input type='text' class='form-control' id='floatingInput'  name='Display_Size' required rows='3' placeholder='Display size'>
            </div>
            <div class='col-auto ms-auto col-sm-3'>
            <input type='text' class='form-control' id='floatingInput'  name='Screen_Resolution' required rows='3' placeholder='Screen resolution'>
            </div>
        </div><br><br>
    </div>
    ...
    if(isset($_POST['Final_Submit'])){
        ...
        $query = "INSERT INTO laptop_details(laptop_name,performance,gaming,display,battery_life,connectivity,total_score)
                VALUES ('$product_name',$performance,$gaming,$display,$battery,$connectivity,$review_score)";
        ...
        if($_FILES["image"]["error"]==4){
            ...
            if($fileSize > 1000000){
              ...
              ";
                ...
                move_uploaded_file($tmpName, '../images/laptops/' . $newImageName);
                // mobile_name,performance,display,battery,camera,connectivity,total_score
                $query="INSERT INTO laptop_image(laptop_name,processor,ram,graphic_processor,display_size,screen_resolution,laptop_image) VALUES
                         ('$product_name','$Processor','$Ram','$Screen_Resolution','$Display_Size','$Graphic_Processor','$newImageName')";
